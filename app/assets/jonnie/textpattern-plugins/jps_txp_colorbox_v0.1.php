...
$plugin [ 'description' ] = 'A light weight jquery colorbox';
...
register_callback ( "jps_colorbox_setup", "pretext" );
register_callback ( "jps_colorbox", "pretext" );


function jps_colorbox_setup( $event )
{
	$js = '';
